...
//Question10
    ...
    public HashMap<String,String> change(String[] animalKey, String[]animalValues,String[] newValues){
	...
	switch(choice){
	  ...
	  case 5:
		...
		case 10:
		      ...
		      HashMap<String,String> mapTen=obj.change(animalKey,animalValues, newValues);
